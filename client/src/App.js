...
import AddArabicLesson from './Components/AddArabicLesson'
import AddLessonEnglish from "./Components/AddEnglishLesson"
...
import ViewEnglishContent from "./Components/ViewEnglishContent";
//import AddEnglishLessonContent from "./Components/AddEnglishLessonContent";
//import EnglishLessonActivity from './Components/EnglishLessonActivity';
import AddEnglishLessonContent from "./Components/AddEnglishLessonContent";
//import EnglishLessonStudent from "./Components/EnglishLessonStudent";
          ...
          <Routes>
            ...
            {user ? (
              <>
                ...
                {/* English Lessons */}
                <Route path="/englishlessont" element={user.role === "teacher" ? <EnglishLessonT /> : <EnglishLessonActivity />} />
                <Route path="/lesson/:id" element={user.role === "teacher" ? <EnglishLessonActivity /> : <Lesson />} />
                {/* Arabic Lessons */}
                <Route path="/arabiclesson" element={user.role === "teacher" ? <ArabicLessonT /> : <ArabicLesson />} />
                <Route path="/arabiclesson/:id" element={user.role === "teacher" ? <ArabicT /> : <Arabic />} />
                <Route path="/arabic/:id" element={<Arabic />} />
                <Route path="/activities" element={<Activities />} />
                <Route path="/activity/:id" element={<Activities />} />
                <Route path="/addlessonarabic" element={<AddArabicLesson />} />
                <Route path="/addlessonenglish" element={<AddLessonEnglish />} />
                ...
                <Route path="/addenglishletter" element={<AddEnglishLetter />} />
                <Route path="/AddEnglishLessonContent/:id" element={<AddEnglishLessonContent />} />
                <Route path="/viewenglishcontent/:id" element={<ViewEnglishContent />} />
